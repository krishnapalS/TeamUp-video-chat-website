...
const notifyNewMessage = "../audio/Message-pop-up.mp3";
  ...
  function welcomeUser() {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        let message = {
          email: "",
          subject: "Please join our TeamUp Video Chat Meeting",
...
function setupLocalMedia(callback, errorback) {
  ...
  navigator.mediaDevices
    ...
    .then((stream) => {
      ...
      myCountTimeImg.className = "fas fa-stopwatch";
      ...
      myHandStatusIcon.className = "far fa-hand-paper";
  ...
  if (
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        let message = {
          email: "",
          subject: "Please join our TeamUp🖥️ Video Chat Meeting",
          body: "Click to join: " + myRoomUrl,
        };
        shareRoomByEmail(message);
      }
...
function getAbout() {
  ...
  Swal.fire({
    ...
    html: `
    <br/>
    <div id="about"><b> A Microsoft Teams clone product made under</b><a href="https://microsoft.acehacker.com/engage2021/index.html" target="_blank"><h1><strong> Microsoft Engage 2021 </strong></h1></a></div>
    <div id="author"><a href="https://www.linkedin.com/in/krishna-pal-deora-b4542b171/" target="_blank">Developer : Krishna Pal Deora</a></div><br>
    <button id="sponsorBtn" class="far fa-heart pulsate" onclick="window.open('mailto:kpsd4050@gmail.com')"> Mail me </button>
    `,
    showClass: {
      popup: "animate__animated animate__fadeInDown",
    },
